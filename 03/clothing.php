...
<div class="wrap">
   <div class="search">
    <form action="clothing.php" method="POST">
...
$sql = "SELECT * FROM products2 WHERE description LIKE'%" . $searchy ."%'";
...
?>
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                . $row['price']. "</div> <a class='button-buy' href='cartAction.php?action=addToCart2&id=" .$row['id']. "'>Add</a> </div> </div> </div></ul>";
            }
        } else {
            echo "0 results";
        }
