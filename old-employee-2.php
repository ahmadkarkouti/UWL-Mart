                        ...
                        <div class="container4">
                            ...
                            <div id="myNav" class="overlay2">
                                ...
                                <div class="containerBar overlay-content" style="margin-top: -50px;">
                                    <ul>
                                        <li><a href="index.php" class="fa fa-home w3-card-4"> Home </a></li>
                                        <li><a href="groceries.php" class="fa fa-cart-arrow-down w3-card-4"> Groceries </a></li>
                                        <li><a href="clothing.php" class="fa fa-tags w3-card-4"> Clothing </a></li>
                                        <li><a href="<?php echo $account; ?>" class="fa fa-male w3-card-4"> Your account </a></li>
                                        <li class="current"><a href="viewCart.php" class="fa fa-shopping-basket w3-card-4" id="bask1"> Basket </a></li>
...
<!--                                         <form action="logout.php">
                                            <?php echo $hide1; ?>
                                                <p><button type="submit" id="logoutItem1"><a>Logout</a></button></p>
                                                <?php echo $hide2; ?>
                                        </form> -->
