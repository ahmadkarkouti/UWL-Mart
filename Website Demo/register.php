...
<body>    
    ...
    <header>
        ...
        <div class="container">
            ...
            <input type="date" class="w3-input" name="dob" />
            <br />
            <label>Mobile Number:</label>
            <input type="text" class="w3-input" name="mnumber" />
            <br />
            <label>Address line:</label>
            <input type="text" class="w3-input" name="address1" />
            <br />
            <label>City:</label>
            <input type="text" class="w3-input" name="address2" />
            <br />
            <label>Post Code:</label>
            <input type="text" class="w3-input" name="pcode" />
            <br />
            <label>Country:</label>
            </br>
